...
require('lazy').setup({
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      --  TODO: verify if a realy need this plugin here
      ...
      -- TODO: update surround to use m isntead of s beacuse s is used by other plugin
  ...
  },
  {
    ...
    config = function()
      local ensureInstalled = require('custom.config.lists').treesitter_ensure_installed
  ...
  -- improve treesiter navigation
  {
    ...
    config = function()
      require('nvim-treesitter-textobjects').setup {
        ...
        move = {
          enable = true,
          set_jumps = true, -- adiciona ao jumplist (CTRL-o / CTRL-i)
          goto_next_start = {
            [']m'] = '@function.outer',
            [']]'] = '@class.outer',
          },
